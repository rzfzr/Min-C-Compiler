...
public interface grammarCVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link grammarCParser#cond}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCond(grammarCParser.CondContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code exprH}
	 * labeled alternative in {@link grammarCParser#expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExprH(grammarCParser.ExprHContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link grammarCParser#relop}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRelop(grammarCParser.RelopContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link grammarCParser#whilee}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitWhilee(grammarCParser.WhileeContext ctx);
	/**
	 * Visit a parse tree produced by {@link grammarCParser#foor}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFoor(grammarCParser.FoorContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code attrSimple}
	 * labeled alternative in {@link grammarCParser#attr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAttrSimple(grammarCParser.AttrSimpleContext ctx);
	/**
